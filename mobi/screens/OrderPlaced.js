    ...
    <>
      ...
      <View className="bg-white">
        ...
        <View className="flex-row justify-between mx-2 border-b border-gray-300">
          <View>
            <Text className="w-20 text-lg font-bold text-yellow-500">Hóa đơn</Text>
          </View>
          <View>
            <Text className="w-25 text-lg font-bold text-yellow-500">Người nhận</Text>
          </View>
          <View className="w-20 items-end">
            <Text className=" text-lg font-bold text-yellow-500 ">Giá</Text>
          </View>
          <View>
            <Text className="w-25 text-lg font-bold text-yellow-500">
              Trạng thái
            </Text>
          </View>
        </View>
                ...
                <View className="flex-row justify-between">
                  ...
                  <View>
                    ...
                    : item.status ==="BEP_XAC_NHAN" ? (
                     ...
                     :(
                      <Text className="w-20 font-semibold text-base text-center text-yellow-500">
                        Đã ra món
                      </Text>
                    )}
                  </View>

...
// import { MinusCircleIcon } from 'react-native-herocons';
...
const DetailScreen = () => {
       ...
       <>
            ...
            <ScrollView className="mb-20 bg-gray-50">
                ...
                <View className="px-2 pt-4">
                    <Text className="text-2xl font-bold text-yellow-800">{data.name}</Text>
    ...
    <AntDesign name="pluscircle" size={24} color="black" />
                ...
                {data.type ==='pizza' ? (<View className="px-2 pt-4">
                    <Text className="text-2xl font-bold text-yellow-500">Chọn loại bánh</Text>
                    ...
                    <View className="bg-gray-200 border border-gray-100 rounded-lg mt-3 px-3 font-bold">
                        ...
                        <View className="flex-row justify-between">
                            <View className="flex-row py-2">
                                ...
                                />
                                <Text className="pt-1 text-lg ">Thịt chín</Text>
                            </View>
                            <View className="flex-row">
                                <Text className="pt-1 text-lg py-2">149,000đ</Text>
                                <Image className="pl-2 w-10 h-10" source={{uri:'https://cdn.icon-icons.com/icons2/2596/PNG/512/dot_icon_155477.png'}} />
                            </View>
                        </View>
                        ...
                        <View className="flex-row justify-between">
                            <View className="flex-row py-2">
                                ...
                                />
                                <Text className="pt-1 text-lg ">Thịt tái</Text>
                            </View>
                            <View className="flex-row">
                                <Text className="pt-1 text-lg py-2">149,000đ</Text>
                                <Image className="pl-2 w-10 h-10" source={{uri:'https://cdn.icon-icons.com/icons2/2596/PNG/512/dot_icon_155477.png'}} />

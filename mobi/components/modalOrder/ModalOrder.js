                ...
                <View style={{ elevation: 20 }} className="w-full bg-white py-5 px-3 rounded-lg h-4/5">
                    <View className="justify-between">
                        <View className="flex-row justify-between">
                            <Text className="text-3xl text-yellow-500 font-bold">Tùy chỉnh hóa đơn </Text>
                            <TouchableOpacity onPress={() => { setVisible(false) }} className="">
                                <XCircleIcon color={"#f2a900"} size={30} />
                            </TouchableOpacity >
                        </View>
                        ...
                        <View className="flex-row items-center border-b border-gray-300">
                            <TouchableOpacity className="py-2 text-xl font-semibold" onPress={user.role === "chef" ? () => handlePressChefAccept() : () => handlePressFail()}>
                                <Text className="text-xl">Xác nhận món</Text>
                            </TouchableOpacity>
                    ...
                    <View>
                        <Text className="text-2xl text-yellow-500 font-bold pt-5">Chi Tiết Đơn Hàng</Text>
                    </View>
                    <ScrollView>
